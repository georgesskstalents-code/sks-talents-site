...
export const lifeSciencesContent: DirectionCSector = {
  ...
  rhBoardLede: "Le recrutement et le Studio IA RH sont deux offres distinctes. Voici, à titre d'exemple, des agents que nous pouvons concevoir pour les dirigeants Life Sciences, ainsi que le résultat business associé à chacun.",
  rhBoard: [
  ...
  finalPrimary: { label: "Je réserve un call de 15 min →", url: "https://calendly.com/g-kengue/talentconsulting" },
...
export const animalHealthContent: DirectionCSector = {
  ...
  rhBoardEyebrow: "Studio IA RH · Offre séparée",
  rhBoardTitle: "Exemples d'agents que nous concevons. Un agent, un résultat.",
  rhBoardLede: "Le recrutement et le Studio IA RH sont deux offres distinctes. Voici, à titre d'exemple, des agents que nous pouvons concevoir pour les dirigeants Animal Health, ainsi que le résultat business associé à chacun.",
  rhBoard: [
