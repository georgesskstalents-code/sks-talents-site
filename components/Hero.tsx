...
export default function Hero() {
  ...
  return (
    <section className="relative isolate overflow-hidden">
      ...
      <div className="container-shell relative pb-2 pt-2 sm:pt-4 lg:pb-3 lg:pt-6">
        <div className="mx-auto max-w-4xl space-y-4 text-left">
          ...
          >
            ...
            <span className="text-brand-ink">
              {proofLabels.trustpilotRatingSlash} <span className="text-brand-stone">·</span>{" "}
              <span className="text-brand-stone">{proof.placementsLabel}</span>
            </span>
          </a>
        </div>
      </div>
