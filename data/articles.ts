...
export const articles: Article[] = [
  ...
  },
  {
    ...
    content:
      "Les protéines alternatives et durables transforment l'industrie du petfood...",
    author: "SKS TALENTS",
    date: "2026-03-26",
    readTime: 11,
    sources: [
