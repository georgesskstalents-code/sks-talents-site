...
export const articles: Article[] = [
  ...
  },
  {
    ...
    internalLinks: [
      ...
      { label: "Article : OT cybersecurity (lab & medtech)", href: "/blog/metiers-diagnostic-ivd" }
    ],
    sources: [
      {
        name: "Aon - Benchmarks de rémunération",
  ...
  },
  {
    ...
    internalLinks: [
      ...
      { label: "Assay Development Scientist Biotech", href: "/job-roles/biotech-senior-scientist-arn-therapeutics" },
      { label: "HL7 Interoperability Architect Diagnostic", href: "/job-roles/diagnostic-data-engineer-clinical" },
...

  {
    ...
    internalLinks: [
      ...
      { label: "DRH Life Sciences Scale-Up Playbook", href: "/blog/structurer-fonction-rh-scale-up" }
    ],
    sources: [
      {
        name: "France Biotech - Panorama France HealthTech 2026",
