...
export const articles: Article[] = [
  ...
  },
  {
    ...
    content: composeArticleContent(
      ...
      "Automatiser suppose d'abord de savoir ce que l'on automatise. Si vos process de recrutement et d'onboarding ne sont pas encore ecrits, commencez par la [structuration RH et la digitalisation des process](/structuration-rh)."
    ),
    author: "SKS TALENTS",
    date: "2026-04-23",
    readTime: 7,
  ...
  },
  {
    ...
    content: composeArticleContent(
      ...
      peopleOpsSignals.trigger,
      "L'ordre de priorite depend de votre organisation cible, pas d'une liste generique. Definir cette organisation est le premier livrable d'une mission de [structuration RH](/structuration-rh)."
    ),
    author: "SKS TALENTS",
    date: "2026-04-21",
    readTime: 7,
  ...
  },
  {
    ...
    content: composeArticleContent(
      ...
      peopleOpsSignals.trigger,
      "Le gain de productivite ne tient que si le process automatise est le bon. Notre page [structuration RH et digitalisation des process](/structuration-rh) detaille les six livrables qui posent ce cadre."
    ),
    author: "SKS TALENTS",
    date: "2026-04-15",
    readTime: 7,
  ...
  },
  {
    ...
    content: composeArticleContent(
      ...
      "Se mettre en conformite suppose une gouvernance ecrite : ce qui reste une decision humaine, ce qui est automatise, ce qui est trace. Ce volet fait partie de nos missions de [structuration RH](/structuration-rh)."
    ),
    author: "SKS TALENTS",
    date: "2026-06-05",
    readTime: 12,
