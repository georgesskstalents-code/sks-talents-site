...
const august2026AnimalHealthBatch: JobRole[] = [
  ...
  },
  {
    ...
    missions: [
      "Piloter et développer un portefeuille de Grands Comptes de la filière porcine.",
      "Identifier les décideurs et parties prenantes clés et construire des relations durables.",
      "Développer les ventes et référencements auprès des comptes stratégiques.",
      "Élaborer les stratégies commerciales et plans d'action adaptés à chaque compte.",
      "Préparer et négocier les propositions commerciales et appels d'offres.",
      "Identifier les opportunités de croissance et anticiper les évolutions du marché.",
      "Consolider et analyser les données de ventes, d'achats et données technico-économiques.",
      "Réaliser les prévisions de ventes, reportings et suivis des KPIs afin de mieux piloter l'activité.",
      "Coordonner les actions avec les équipes commerciales, techniques et marketing.",
      "Maintenir une forte proximité avec le terrain et la filière porcine : élevages, audits, vaccination, environnement concurrentiel et événements professionnels."
    ],
    studies: [
      "Docteur.e vétérinaire OU ingénieur.e agri / agro OU école de commerce",
