...
const august2026AnimalHealthBatch: JobRole[] = [
  ...
  },
  {
    ...
    missions: [
      "Suivre un portefeuille de clients Grands Comptes et les différentes structures qui les composent.",
      "Identifier l'ensemble des acteurs et décisionnaires et assurer leur suivi relationnel.",
      "Développer et entretenir des relations de long terme avec les décisionnaires.",
      "Participer aux manifestations professionnelles.",
      "Assurer une veille sur l'évolution des structures de décision.",
      "Connaître la concurrence, les leaders d'opinion et leur influence sur le marché.",
      "Identifier et analyser les opportunités de croissance.",
      "Développer les ventes et les référencements auprès des Grands Comptes.",
      "Présenter et promouvoir les produits auprès des interlocuteurs identifiés.",
      "Participer à l'élaboration des stratégies dédiées aux Grands Comptes.",
      "Contribuer à l'élaboration de la politique commerciale.",
      "Préparer et négocier les propositions commerciales lors des appels d'offres.",
      "Proposer, animer et suivre les plans d'action marketing et techniques dédiés.",
      "Analyser les spécificités des clients et proposer les plans d'action adaptés.",
      "Mettre en œuvre et suivre les prestations définies dans le cadre des accords.",
      "Définir et suivre les indicateurs de mesure et de contrôle des actions.",
      "Informer les clients de l'avancement des plans d'action et des contrats annuels.",
      "Fournir les prévisions trimestrielles de ventes terrain pour les clients suivis.",
      "Consolider et analyser les données d'achats des Grands Comptes.",
      "Consolider et assurer le reporting des ventes.",
      "Exploiter les données pour optimiser le ciblage et la couverture des clients.",
      "Analyser les opportunités commerciales à partir des données disponibles.",
      "Anticiper les tendances du marché.",
      "Suivre les indicateurs de performance.",
      "Travailler avec les équipes commerciales, techniques et marketing.",
      "Coordonner les actions définies pour les Grands Comptes.",
      "Participer activement aux réunions commerciales.",
      "Développer en continu sa connaissance des produits, clients, concurrents et du marché.",
      "Analyser les tableaux de bord technico-économiques des élevages.",
      "Analyser les données d'abattage.",
      "Réaliser des audits.",
      "Former le personnel d'élevage aux bonnes pratiques de vaccination et aux pratiques associées.",
      "Assurer une bonne connaissance du médicament, de son marché et de ses concurrents.",
      "Représenter l'entreprise lors des manifestations professionnelles."
    ],
    studies: [
      "Docteur.e vétérinaire OU ingénieur.e agri / agro OU école de commerce",
      "Expérience commerciale en filière porcine ou en santé animale, de junior à confirmé.e",
    ...
    relatedIndustries: [
      ...
      "Groupements, coopératives et intégrateurs porcins",
      "Nutrition animale, filière porc",
      "Génétique porcine et sélection",
      "Abattoirs et industriels de la filière porc"
    ],
    sources: [
