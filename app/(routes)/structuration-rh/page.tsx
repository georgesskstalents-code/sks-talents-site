...
const webPageNode = {
  "@type": "WebPage",
  "@id": `${STRUCTURATION_RH_CANONICAL}#webpage`,
  url: STRUCTURATION_RH_CANONICAL,
  name: TITLE,
  description: DESCRIPTION,
  inLanguage: "fr-FR",
  isPartOf: { "@id": WEBSITE_ID },
  // Le Service est defini une seule fois, dans le graphe du site.
  mainEntity: { "@id": SERVICE_STRUCTURATION_RH_ID },
  about: { "@id": SERVICE_STRUCTURATION_RH_ID },
  provider: orgRef
};
