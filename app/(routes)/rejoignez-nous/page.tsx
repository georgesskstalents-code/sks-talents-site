...
const faqItems = [
  ...
  },
  {
    ...
    answer:
      "Vous pouvez réserver un créneau via Calendly, demander à être rappelé depuis le formulaire inline ou écrire directement à g.kengue@skstalents.fr."
  }
] as const;
        ...
        <div className="grid gap-6 lg:grid-cols-[1.05fr_0.95fr]">
          <div className="card-surface p-8">
            ...
            <div className="mt-6 flex flex-wrap gap-3">
              ...
              <CalendlyButton
                label="Écrire à g.kengue@skstalents.fr"
      ...
      >
        <div className="grid gap-6 lg:grid-cols-[1.05fr_0.95fr]">
          ...
          <div className="card-surface p-8">
            ...
            <h3 className="mt-3 font-display text-3xl text-brand-ink">g.kengue@skstalents.fr</h3>
