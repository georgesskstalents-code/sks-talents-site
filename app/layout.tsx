...
const baseKeywords = [
  ...
  "digitalisation santé animale",
  "digitalisation santé animale par l'IA",
  "digitalisation groupement vétérinaire",
  "digitalisation clinique vétérinaire",
  "digitalisation petfood",
